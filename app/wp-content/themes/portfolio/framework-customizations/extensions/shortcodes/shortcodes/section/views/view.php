...
//custom
$custom_id = ( isset( $atts['custom_id'] ) && $atts['custom_id'] ) ? $atts['custom_id'] : ''; // если сущствует custom_id и $atts['custom_id'] тогда мы присваеваем (?) $atts['custom_id'] в переменную $custom_id

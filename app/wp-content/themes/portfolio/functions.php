...
function portfolio_scripts() {
    ...
    wp_enqueue_style( 'portfolio-min-css',get_template_directory_uri() . '/assets/css/app.min.css' );
    wp_enqueue_style( 'portfolio-animate-css',get_template_directory_uri() . '/assets/libs/animate/animate.min.css' );
    wp_enqueue_style( 'portfolio-linea-css',get_template_directory_uri() . '/assets/libs/linea/styles.css' );


    wp_enqueue_script( 'portfolio-scripts',get_template_directory_uri() . '/assets/js/app.min.js' , array('jquery'), _S_VERSION, true );
    wp_localize_script('portfolio-scripts', 'portDate', array(
        'themePath' => get_template_directory_uri(),
        'bgPath' => $url=portfolio_theme_option('top_bg_img')
));
...
//    wp_localize_script('ajax', 'myPlugin', array(
//        'ajaxurl' => admin_url('admin-ajax.php'),
//        'name' => wp_get_current_user() ->display_name
//    ));
//}
...
function portfolio_theme_option ($name){
    if(defined('FW')){
        return fw_get_db_settings_option($name);
        //return debug(fw_get_db_settings_option($name));
    }else{
        $name = __('For correctly work theme , install the Unyson plugin', 'fw');
        return $name;
    }
}
